...
const UsersModel = require('./src/auth/models/users-model.js');
...
//extracted to src/auth/models/users-model.js
...
//end extraction to src/auth/models/users-model.js
...
// Extracted to src/auth/middleware/basic.js
...
routerSignUp.post('/signup', async (req, res, next) => {
...
routerSignIn.post('/signin', basicAuth, (req, res, next) => {
